...
export const STUDELIO_STANDARD_MODULES: ChapterSeed[] = [
  {
    ...
    objectives: ["Structure de la phrase", "Nature et fonctions des mots"],
    skills: ["Grammaire"],
  },
  {
    order: 2,
    ...
    objectives: ["Orthographe courante", "Accords et homophones"],
    skills: ["Orthographe"],
  },
  {
    order: 3,
    ...
    objectives: ["Temps verbaux", "Modes"],
    skills: ["Conjugaison"],
  },
  {
    order: 4,
    ...
    objectives: ["Compréhension de texte", "Repérer l’essentiel"],
    skills: ["Lecture"],
  },
  {
    order: 5,
    ...
    objectives: ["Argumentation", "Cohérence du texte"],
  ...
  },
  {
    ...
    objectives: ["Comprendre et s’exprimer", "Champs lexicaux"],
    skills: ["Vocabulaire"],
  },
];
